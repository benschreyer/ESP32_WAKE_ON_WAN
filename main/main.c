...
//magic packet 6 0xFF followed by 16 repetitions of the MAC ADDR of the device
static const char pl[] = {0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xC0,0xDE,};//... needs a real MAC ADDRESS
static const char *payload = &pl;
...
long int boot_last_time = (long int)0;
...
static esp_err_t hello_get_handler(httpd_req_t *req)
{
    ...
    if((long int) cur - boot_last_time > 20)
    {
...
static const httpd_uri_t hello = {
    ...
    .user_ctx  = "Hello World!(MAGIC PACKET)!\n"
};
